...
namespace ProgrammersBlog.Data.Concrete.EntityFramework.Mappings
{
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(u => u.Id).ValueGeneratedOnAdd();//Identity
            builder.Property(u => u.EMail).IsRequired();
            builder.Property(u => u.EMail).HasMaxLength(50);
            builder.HasIndex(u => u.EMail).IsUnique();//tek mailden kayıt olma
            ...
            builder.Property(u => u.LastName).HasMaxLength(35);
            ...
            builder.HasData(new User
            {
                ...
                PasswordHash=Encoding.ASCII.GetBytes("e66055e8e308770492a44bf16e875127"),
