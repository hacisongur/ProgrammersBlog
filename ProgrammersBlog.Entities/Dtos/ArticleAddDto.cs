...
namespace ProgrammersBlog.Entities.Dtos
{
    ...
    {  
        ...
        [MinLength(100, ErrorMessage = "{0} alanı {1}karekterden küyük olmamalıdır.")]
        public string Title { get; set; }
        [DisplayName("İçerik")]
        [Required(ErrorMessage = "{0} alanı boş geçilmemelidir.")]
        [MinLength(20, ErrorMessage = "{0} alanı {1}karekterden küyük olmamalıdır.")]
        ...
        [MinLength(0, ErrorMessage = "{0} alanı {1}karekterden küyük olmamalıdır.")]
